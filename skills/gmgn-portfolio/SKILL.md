...
All portfolio routes used by this skill go through GMGN's leaky-bucket limiter. The rate/capacity is resolved automatically from the API Key's paid-plan tier — it is not something the CLI or caller configures:
